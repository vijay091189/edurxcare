...
<div class="page">
    <div class="page-content container-fluid">
      <h4 style="color: #232e74;padding-left:38px;"><strong>Recommendations</strong></h4>
      <div class="row" style="padding:15px;margin-left: 10px;">
        @if(count($details)>0)
          ...
          @endforeach
        @else
          <div style="text-align:center;"><h4>No Recommendations found</h4></div>
        @endif
      </div>
    </div>
  </div>  
