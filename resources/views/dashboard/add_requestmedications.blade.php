...
<div class="page">
    <div class="page-content container-fluid">
      <div class="d-flex justify-content-between">
        <h4 style="color: #232e74;padding-left:38px;"><strong>Add Medicine&nbsp;<i class="fa fa-info-circle score_info" data-toggle="tooltip" title="" data-original-title="Medication currently taking"></i></strong></h4>
